...
class User implements IModel
{
    ...
    public function __construct(PDO $pdo)
    {
        ...
        $this->_fieldsOnly = ['id', 'name', 'email', 'password', 'emailVerified', 'google2faSecret', 'isGoogle2faActive', 'image', 'createdAt', 'updatedAt', 'roleId'];
        $this->_tableFieldsOnly = ['id', 'name', 'email', 'password', 'emailVerified', 'google2faSecret', 'isGoogle2faActive', 'image', 'createdAt', 'updatedAt', 'roleId'];
        ...
        $this->_uniqueFields = ['email'];
        $this->_primaryKeyAndUniqueFields = ['id', 'email'];
        $this->_fieldsCombined = ['id', 'name', 'email', 'password', 'emailVerified', 'google2faSecret', 'isGoogle2faActive', 'image', 'createdAt', 'updatedAt', 'roleId', 'userRole'];
